...
#define DHT_PIN 0 // pin connected to data pin of DHT11
#define DHT_TYPE DHT11

#define WIFI_SSID "Bwtm56" // your wifi ssid
#define WIFI_PASSWD "radheradhe123" //your wifi password

#define CLIENT_ID "NodeMCUSTarter-hgsdh2131h23h"// thing unique ID, can be any unique id
#define MQTT_TOPIC "$aws/things/NodeMCU1/shadow/update" //topic for the MQTT data
#define AWS_HOST "aatpj4hf0x7f1-ats.iot.ap-south-1.amazonaws.com" // your host for uploading data to AWS,
