        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../../pages/forms/farmerprofile.html">
              ...
              <span class="menu-title">Elevator Profile</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="Elevatorlot.html">
              <i class="menu-icon mdi mdi-backup-restore"></i>
              <span class="menu-title">Submit Shipment details</span>
            </a>
          </li>                     
