  ...
  <div class="container-scroller">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav navbar-nav-left header-links d-none d-md-flex">
          <li class="nav-item">
            <a href="../../index.html" class="nav-link">Search Product</a>
          </li>
        </ul>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auto-form-wrapper">
              <form action="validation.php" method="POST"> 
                ...
                <div class="form-group">
                    <a href ="register.php" class="btn btn-block g-login" >Sign up</a>
                  </div>
                <!-- <div class="text-block text-center my-3">
                  <a href="../../" class="text-black text-small">Click here to search Product Details</a>
                </div> -->
              </form> 
            </div>
            <p class="footer-text text-center">Made with love by Team IDK</p>
          </div>
        </div>
      </div>
