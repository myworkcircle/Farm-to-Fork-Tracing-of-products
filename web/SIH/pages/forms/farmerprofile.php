    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../../pages/forms/newlot.php">
              <i class="menu-icon mdi mdi-backup-restore"></i>
              <span class="menu-title">As Self</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../../pages/forms/newlot.php">
              <i class="menu-icon mdi mdi-backup-restore"></i>
              <span class="menu-title">Via Helpdesk</span>
            </a>
          </li>
          <li class="nav-item" >
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Alloted id</label>
                          <div class="col-sm-9">
                           <p class="col-sm-6  col-form-label"> <?php echo "$farmer_id";?> </p>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                        <p class="col-sm-6  col-form-label"> <?php echo "$fertilizers";?> </p>
                          </div>
                        </div>
