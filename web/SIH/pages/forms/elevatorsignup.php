                ...
                <div class="col-12 stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form action="updateelevator.php" method="POST" class="forms-sample">
                        
                        

                        <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Name of the registered Company</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="company" >
                          </div>
                        </div>
                          <div class="form-group row">
                          <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Mode of Transport</label>
                          <div class="col-sm-9">
